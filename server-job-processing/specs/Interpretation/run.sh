...
python3 "$REFORMAT_SCRIPT" --input "$JSON_FILE" --output "$REFORMATTED_FILE" --silent && {
    ...
    interprete run -i "$REFORMATTED_FILE" -o states --model genus --model_folder /home/pmuench/Labs/server-job-processing/models/
    interprete run -i "$REFORMATTED_FILE" -o states --model crispr --model_folder /home/pmuench/Labs/server-job-processing/models/
    interprete run -i "$REFORMATTED_FILE" -o states --model genomenet --model_folder /home/pmuench/Labs/server-job-processing/models/
    echo "Done"
